...
/**
 * CommissionRange Class Doc Comment
 *
 * @category Class
 ...
 */
class CommissionRange implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CommissionRange';
    ...
    */
     ...
     * Sets lower
     *
     * @param float $lower The inclusive lower price threshold for which the commission is valid.
     *
     * @return self
     */
     ...
     * Sets upper
     *
     * @param float|null $upper The exclusive upper price threshold for which the commission is valid.
     *
     * @return self
     */
