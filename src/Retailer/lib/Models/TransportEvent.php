...
class TransportEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const EVENT_CODE_INBOUND_COLLECT = 'INBOUND_COLLECT';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('eventDateTime', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['eventCode']) && !in_array($this->container['eventCode'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'eventCode', must be one of '%s'",
                $this->container['eventCode'],
                implode("', '", $allowedValues)
            );
        }

        if ($this->container['eventDateTime'] === null) {
            $invalidProperties[] = "'eventDateTime' can't be null";
        }
     ...
     * Sets eventCode
     *
     * @param string $eventCode The transport event code indicates the location of the parcel within the distribution process.
     *
     * @return self
     */
    public function setEventCode($eventCode)
    {
        ...
        $allowedValues = $this->getEventCodeAllowableValues();
        if (!in_array($eventCode, $allowedValues, true)) {
    ...
    {
        return $this->container['eventDateTime'];
    }

    /**
     * Sets eventDateTime
     *
     * @param \DateTime $eventDateTime The date time of the transport event.
     *
     * @return self
     */
    public function setEventDateTime($eventDateTime)
    {
        if (is_null($eventDateTime)) {
            throw new \InvalidArgumentException('non-nullable eventDateTime cannot be null');
        }
        $this->container['eventDateTime'] = $eventDateTime;
