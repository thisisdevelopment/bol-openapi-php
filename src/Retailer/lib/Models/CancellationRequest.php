...
class CancellationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'orderItems' => '\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\OrderItemCancellation[]'
    ];
    ...
    */
     ...
     * Gets orderItems
     *
     * @return \ThisIsDevelopment\OpenApi\Bol\Retailer\Models\OrderItemCancellation[]
     */
     ...
     * Sets orderItems
     *
     * @param \ThisIsDevelopment\OpenApi\Bol\Retailer\Models\OrderItemCancellation[] $orderItems List of order items to cancel. Order item id's must belong to the same order.
     *
     * @return self
     */
    public function setOrderItems($orderItems)
    {
        ...
        if ((count($orderItems) > 1)) {
            throw new \InvalidArgumentException('invalid value for $orderItems when calling CancellationRequest., number of items must be less than or equal to 1.');
        }
        if ((count($orderItems) < 1)) {
            throw new \InvalidArgumentException('invalid length for $orderItems when calling CancellationRequest., number of items must be greater than or equal to 1.');
        }
