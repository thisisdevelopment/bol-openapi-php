...
class SubscriptionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const RESOURCES_PRICE_STAR_BOUNDARY = 'PRICE_STAR_BOUNDARY';
    public const RESOURCES_COMPETING_OFFER = 'COMPETING_OFFER';
    public const SUBSCRIPTION_TYPE_WEBHOOK = 'WEBHOOK';
    public const SUBSCRIPTION_TYPE_GCP_PUBSUB = 'GCP_PUBSUB';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['subscriptionType']) && !in_array($this->container['subscriptionType'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'subscriptionType', must be one of '%s'",
     ...
     * Sets resources
     *
     * @param string[] $resources Array of event types for which the subscription is set. Note that some event types are only available for certain subscription types.
     *
     * @return self
     */
     ...
     *
     * @param string $subscriptionType The type of subscription. It indicates the platform where the events will be subscribed to. Be aware that certain event types are only available for specific types.
     *
     * @return self
     */
