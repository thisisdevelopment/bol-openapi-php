 ...
 */
class ProductRatingsRating implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductRatingsRating';
    ...
    */
     ...
     * Sets count
     *
     * @param int|null $count The number of ratings for the corresponding scale.
     *
     * @return self
     */
