...
class Countries implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets countryCode
     *
     * @param string|null $countryCode Countries in which this offer is currently on sale in the webshop, in ISO-3166-1 format.
     *
     * @return self
     */
     ...
     * Sets minimum
     *
     * @param float $minimum Minimum number of estimated sales expectations on the bol.com platform.
     *
     * @return self
     */
     ...
     * Sets maximum
     *
     * @param float $maximum Maximum number of estimated sales expectations on the bol.com platform.
     *
     * @return self
     */
