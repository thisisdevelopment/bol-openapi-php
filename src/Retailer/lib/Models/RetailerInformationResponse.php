...
class RetailerInformationResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['kvkNumber'] === null) {
            $invalidProperties[] = "'kvkNumber' can't be null";
        }
     ...
     * Sets companyName
     *
     * @param string $companyName The company name of the retailer.
     *
     * @return self
     */
     ...
     * Sets vatNumber
     *
     * @param string $vatNumber The VAT number of the retailer.
     *
     * @return self
     */
     ...
     * Sets kvkNumber
     *
     * @param string $kvkNumber The KVK number of the retailer.
     *
     * @return self
     */
