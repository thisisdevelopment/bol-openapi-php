...
class Categories implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'categoryName' => 'string',
        'categoryValues' => '\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\CategoryValues[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('categoryValues', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['categoryValues'] === null) {
            $invalidProperties[] = "'categoryValues' can't be null";
        }
     ...
     * Sets categoryName
     *
     * @param string $categoryName The name of the categories.
     *
     * @return self
     */
     ...
     * Gets categoryValues
     *
     * @return \ThisIsDevelopment\OpenApi\Bol\Retailer\Models\CategoryValues[]
     */
    public function getCategoryValues()
    {
        return $this->container['categoryValues'];
    }

    /**
     * Sets categoryValues
     *
     * @param \ThisIsDevelopment\OpenApi\Bol\Retailer\Models\CategoryValues[] $categoryValues The list of available categories.
     *
     * @return self
     */
    public function setCategoryValues($categoryValues)
    {
        if (is_null($categoryValues)) {
            throw new \InvalidArgumentException('non-nullable categoryValues cannot be null');
        }
        $this->container['categoryValues'] = $categoryValues;
