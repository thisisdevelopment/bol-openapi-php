...
class CreateDeliveryInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string $expectedDeliveryDate The expected delivery date of the shipment at the bol.com warehouse. In ISO 8601 format.
     *
     * @return self
     */
     ...
     *
     * @param string $transporterCode The transporter code that correlates to the transport used for this replenishment.
     *
     * @return self
     */
