 ...
 */
class ProductAssetsVariants implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductAssetsVariants';
    ...
    public const MIME_TYPE_APPLICATION_X_MPEGURL = 'application/x-mpegurl';
    ...
    public function getMimeTypeAllowableValues()
    {
        return [
            ...
            self::MIME_TYPE_APPLICATION_X_MPEGURL,
