...
class SubCategory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubCategory';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The id of the subcategory which the product belongs to.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of the subcategory which the product belongs to.
     *
     * @return self
     */
