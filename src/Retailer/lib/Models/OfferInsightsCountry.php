...
class OfferInsightsCountry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets countryCode
     *
     * @param string $countryCode Countries in which this offer is currently on sale in the webshop, in ISO-3166-1 format.
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param float $value The total value of offer insight.
     *
     * @return self
     */
