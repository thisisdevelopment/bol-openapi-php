 ...
 */
class DeliveryOptionsRequestOrderItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeliveryOptionsRequestOrderItem';
    ...
    */
     ...
     * Sets orderItemId
     *
     * @param string $orderItemId The id for the order item (1 order can have multiple order items).
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param int|null $quantity The quantity of the order item for which the shipping label creation is requested for. If omitted, will be interpreted as the full quantity that is still open for this order item.
     *
     * @return self
     */
