 ...
 */
class Serie implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Serie';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The name of the product serie(s) the EAN belongs to.
     *
     * @return self
     */
