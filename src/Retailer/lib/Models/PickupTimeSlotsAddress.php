...
class PickupTimeSlotsAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['zipCode']) > 8)) {
     ...
     * Sets streetName
     *
     * @param string $streetName The street name of the pickup address.
     *
     * @return self
     */
     ...
     * Sets houseNumber
     *
     * @param string $houseNumber The house number of the pickup address.
     *
     * @return self
     */
     ...
     *
     * @param string|null $houseNumberExtension The extension of the house number.
     *
     * @return self
     */
    ...
    public function setZipCode($zipCode)
    {
        ...
        if ((mb_strlen($zipCode) > 8)) {
            throw new \InvalidArgumentException('invalid length for $zipCode when calling PickupTimeSlotsAddress., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($zipCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $zipCode when calling PickupTimeSlotsAddress., must be bigger than or equal to 1.');
        }
