...
/**
 * InvoiceRequestsProducts Class Doc Comment
 *
 * @category Class
 * @package  ThisIsDevelopment\OpenApi\Bol\Retailer
 * @author   OpenAPI Generator team
 ...
 */
class InvoiceRequestsProducts implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvoiceRequestsProducts';
    ...
    */
     ...
     * Sets description
     *
     * @param string|null $description The description of the ordered product.
     *
     * @return self
     */
     ...
     * Sets unitPrice
     *
     * @param float|null $unitPrice The selling price to the customer of a single unit including VAT.
     *
     * @return self
     */
