...
class OrderItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets quantity
     *
     * @param int|null $quantity The quantity of the order items to ship. If omitted, will be interpreted as the full quantity that is still open for this order item.
     *
     * @return self
     */
