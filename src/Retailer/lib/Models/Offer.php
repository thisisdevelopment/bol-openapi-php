...
class Offer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param \DateTime|null $maxDeliveryDate The date at which package can be delivered to customer latest. In case of pre-orders where a specific delivery date is not available, this field will not be present.
     *
     * @return self
     */
