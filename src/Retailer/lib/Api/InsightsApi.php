...
class InsightsApi
{
     ...
     * @param  string $acceptLanguage The language to search for. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getProductRanks'] to see the possible values for this operation
     *
     * @throws \ThisIsDevelopment\OpenApi\Bol\Retailer\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \ThisIsDevelopment\OpenApi\Bol\Retailer\Models\ProductRanks|\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\Problem|\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\Problem
     */
    public function getProductRanks($ean, $date, $type = null, $page = 1, $acceptLanguage = null, string $contentType = self::contentTypes['getProductRanks'][0])
    {
        list($response) = $this->getProductRanksWithHttpInfo($ean, $date, $type, $page, $acceptLanguage, $contentType);
        return $response;
    }
     ...
     * @throws \ThisIsDevelopment\OpenApi\Bol\Retailer\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \ThisIsDevelopment\OpenApi\Bol\Retailer\Models\ProductRanks|\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\Problem|\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\Problem, HTTP status code, HTTP response headers (array of strings)
     */
    public function getProductRanksWithHttpInfo($ean, $date, $type = null, $page = 1, $acceptLanguage = null, string $contentType = self::contentTypes['getProductRanks'][0])
    {
        $request = $this->getProductRanksRequest($ean, $date, $type, $page, $acceptLanguage, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\ProductRanks' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\ProductRanks' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\ProductRanks', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\ProductRanks';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\ProductRanks',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProductRanksAsync($ean, $date, $type = null, $page = 1, $acceptLanguage = null, string $contentType = self::contentTypes['getProductRanks'][0])
    {
        return $this->getProductRanksAsyncWithHttpInfo($ean, $date, $type, $page, $acceptLanguage, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProductRanksAsyncWithHttpInfo($ean, $date, $type = null, $page = 1, $acceptLanguage = null, string $contentType = self::contentTypes['getProductRanks'][0])
    {
        $returnType = '\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\ProductRanks';
        $request = $this->getProductRanksRequest($ean, $date, $type, $page, $acceptLanguage, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getProductRanksRequest($ean, $date, $type = null, $page = 1, $acceptLanguage = null, string $contentType = self::contentTypes['getProductRanks'][0])
    {
        ...
        if ($page !== null && $page > 200) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling InsightsApi.getProductRanks, must be smaller than or equal to 200.');
        }
        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling InsightsApi.getProductRanks, must be bigger than or equal to 1.');
        }
