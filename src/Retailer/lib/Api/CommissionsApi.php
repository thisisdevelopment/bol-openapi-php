...
class CommissionsApi
{
     ...
     *
     * @param  \ThisIsDevelopment\OpenApi\Bol\Retailer\Models\CommissionProducts $commissionProducts commissionProducts (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getCommissionRates'] to see the possible values for this operation
     *
     * @throws \ThisIsDevelopment\OpenApi\Bol\Retailer\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \ThisIsDevelopment\OpenApi\Bol\Retailer\Models\BulkCommissionRatesMultiStatusResponse|\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\Problem
     */
    public function getCommissionRates($commissionProducts, string $contentType = self::contentTypes['getCommissionRates'][0])
    {
        list($response) = $this->getCommissionRatesWithHttpInfo($commissionProducts, $contentType);
        return $response;
    }
     ...
     * Get a list of commissions by EAN (BETA)
     *
     * @param  \ThisIsDevelopment\OpenApi\Bol\Retailer\Models\CommissionProducts $commissionProducts (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getCommissionRates'] to see the possible values for this operation
     *
     * @throws \ThisIsDevelopment\OpenApi\Bol\Retailer\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \ThisIsDevelopment\OpenApi\Bol\Retailer\Models\BulkCommissionRatesMultiStatusResponse|\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\Problem, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCommissionRatesWithHttpInfo($commissionProducts, string $contentType = self::contentTypes['getCommissionRates'][0])
    {
        $request = $this->getCommissionRatesRequest($commissionProducts, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 207:
                    if ('\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\BulkCommissionRatesMultiStatusResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\BulkCommissionRatesMultiStatusResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\BulkCommissionRatesMultiStatusResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\BulkCommissionRatesMultiStatusResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 207:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\BulkCommissionRatesMultiStatusResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCommissionRatesAsync($commissionProducts, string $contentType = self::contentTypes['getCommissionRates'][0])
    {
        return $this->getCommissionRatesAsyncWithHttpInfo($commissionProducts, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCommissionRatesAsyncWithHttpInfo($commissionProducts, string $contentType = self::contentTypes['getCommissionRates'][0])
    {
        $returnType = '\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\BulkCommissionRatesMultiStatusResponse';
        $request = $this->getCommissionRatesRequest($commissionProducts, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCommissionRatesRequest($commissionProducts, string $contentType = self::contentTypes['getCommissionRates'][0])
    {

        // verify the required parameter 'commissionProducts' is set
        if ($commissionProducts === null || (is_array($commissionProducts) && count($commissionProducts) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $commissionProducts when calling getCommissionRates'
            );
        }
        ...
        // for model (json/xml)
        if (isset($commissionProducts)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($commissionProducts));
            } else {
                $httpBody = $commissionProducts;
            }
