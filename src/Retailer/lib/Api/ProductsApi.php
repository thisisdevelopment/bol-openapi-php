...
class ProductsApi
{
     ...
     *
     * @param  string $ean The EAN number associated with this product. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getPriceStarBoundaries'] to see the possible values for this operation
     *
     * @throws \ThisIsDevelopment\OpenApi\Bol\Retailer\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \ThisIsDevelopment\OpenApi\Bol\Retailer\Models\PriceStarBoundaries|\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\Problem|\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\Problem
     */
    public function getPriceStarBoundaries($ean, string $contentType = self::contentTypes['getPriceStarBoundaries'][0])
    {
        list($response) = $this->getPriceStarBoundariesWithHttpInfo($ean, $contentType);
        return $response;
    }
     ...
     * @throws \ThisIsDevelopment\OpenApi\Bol\Retailer\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \ThisIsDevelopment\OpenApi\Bol\Retailer\Models\PriceStarBoundaries|\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\Problem|\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\Problem, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPriceStarBoundariesWithHttpInfo($ean, string $contentType = self::contentTypes['getPriceStarBoundaries'][0])
    {
        $request = $this->getPriceStarBoundariesRequest($ean, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\PriceStarBoundaries' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\PriceStarBoundaries' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\PriceStarBoundaries', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
            ...
            $returnType = '\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\PriceStarBoundaries';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\PriceStarBoundaries',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPriceStarBoundariesAsync($ean, string $contentType = self::contentTypes['getPriceStarBoundaries'][0])
    {
        return $this->getPriceStarBoundariesAsyncWithHttpInfo($ean, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPriceStarBoundariesAsyncWithHttpInfo($ean, string $contentType = self::contentTypes['getPriceStarBoundaries'][0])
    {
        $returnType = '\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\PriceStarBoundaries';
        $request = $this->getPriceStarBoundariesRequest($ean, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getPriceStarBoundariesRequest($ean, string $contentType = self::contentTypes['getPriceStarBoundaries'][0])
    {
