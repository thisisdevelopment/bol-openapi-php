...
class InventoryApi
{
     ...
     * @return \ThisIsDevelopment\OpenApi\Bol\Retailer\Models\InventoryResponse|\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\Problem
     */
    public function getInventory($page = 1, $quantity = null, $stock = null, $state = null, $query = null, string $contentType = self::contentTypes['getInventory'][0])
    {
        list($response) = $this->getInventoryWithHttpInfo($page, $quantity, $stock, $state, $query, $contentType);
        return $response;
    }
     ...
     * @throws \ThisIsDevelopment\OpenApi\Bol\Retailer\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \ThisIsDevelopment\OpenApi\Bol\Retailer\Models\InventoryResponse|\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\Problem, HTTP status code, HTTP response headers (array of strings)
     */
    public function getInventoryWithHttpInfo($page = 1, $quantity = null, $stock = null, $state = null, $query = null, string $contentType = self::contentTypes['getInventory'][0])
    {
        $request = $this->getInventoryRequest($page, $quantity, $stock, $state, $query, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\InventoryResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\InventoryResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\InventoryResponse', []),
            ...
            $returnType = '\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\InventoryResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\InventoryResponse',
     ...
     */
    public function getInventoryAsync($page = 1, $quantity = null, $stock = null, $state = null, $query = null, string $contentType = self::contentTypes['getInventory'][0])
    {
        return $this->getInventoryAsyncWithHttpInfo($page, $quantity, $stock, $state, $query, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInventoryAsyncWithHttpInfo($page = 1, $quantity = null, $stock = null, $state = null, $query = null, string $contentType = self::contentTypes['getInventory'][0])
    {
        $returnType = '\ThisIsDevelopment\OpenApi\Bol\Retailer\Models\InventoryResponse';
        $request = $this->getInventoryRequest($page, $quantity, $stock, $state, $query, $contentType);
     ...
     */
    public function getInventoryRequest($page = 1, $quantity = null, $stock = null, $state = null, $query = null, string $contentType = self::contentTypes['getInventory'][0])
    {
