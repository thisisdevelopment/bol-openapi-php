...
/**
 * CreateTargetProductRequest Class Doc Comment
 *
 * @category Class
 * @package  ThisIsDevelopment\OpenApi\Bol\Advertiser
 * @author   OpenAPI Generator team
 ...
 */
class CreateTargetProductRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateTargetProductRequest';
    ...
    */
     ...
     * Sets ean
     *
     * @param string $ean The EAN associated with the target product.
     *
     * @return self
     */
    ...
    public function setBid($bid)
    {
        ...
        if (($bid < 0)) {
            throw new \InvalidArgumentException('invalid value for $bid when calling CreateTargetProductRequest., must be bigger than or equal to 0.');
        }
