...
class UpdateKeywordRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets bid
     *
     * @param float $bid The bid price. The price should always have two decimals of precision.
     *
     * @return self
     */
    public function setBid($bid)
    {
        ...
        if (($bid < 0)) {
            throw new \InvalidArgumentException('invalid value for $bid when calling UpdateKeywordRequest., must be bigger than or equal to 0.');
        }
