...
class UpdateAdGroupRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets state
     *
     * @param string|null $state The state of the ad group.
     *
     * @return self
     */
    ...
    public function setDefaultBid($defaultBid)
    {
        ...
        if (($defaultBid < 0)) {
            throw new \InvalidArgumentException('invalid value for $defaultBid when calling UpdateAdGroupRequest., must be bigger than or equal to 0.');
        }
