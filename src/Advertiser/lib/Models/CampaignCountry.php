...
/**
 * CampaignCountry Class Doc Comment
 *
 * @category Class
 * @package  ThisIsDevelopment\OpenApi\Bol\Advertiser
 * @author   OpenAPI Generator team
 ...
 */
class CampaignCountry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignCountry';
    ...
    */
     ...
     * Sets countryCode
     *
     * @param string $countryCode The target country in which your ads need to be shown.
     *
     * @return self
     */
