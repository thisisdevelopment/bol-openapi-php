...
class Keyword implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets keywordId
     *
     * @param string|null $keywordId The identifier of the keyword.
     *
     * @return self
     */
     ...
     * Sets state
     *
     * @param string|null $state The current state of the keyword.
     *
     * @return self
     */
     ...
     * Sets matchType
     *
     * @param string|null $matchType The match type that relates the keyword and the search term.
     *
     * @return self
     */
