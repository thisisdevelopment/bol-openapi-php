...
/**
 * AdGroupPerformance Class Doc Comment
 *
 * @category Class
 * @package  ThisIsDevelopment\OpenApi\Bol\Advertiser
 * @author   OpenAPI Generator team
 ...
 */
class AdGroupPerformance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdGroupPerformance';
    ...
    */
     ...
     * Sets date
     *
     * @param string|null $date The date to which the ad group results are aggregated.
     *
     * @return self
     */
     ...
     * Sets adGroupName
     *
     * @param string|null $adGroupName The name of the ad group.
     *
     * @return self
     */
    public function setAdGroupName($adGroupName)
    {
        if (is_null($adGroupName)) {
            throw new \InvalidArgumentException('non-nullable adGroupName cannot be null');
        }
     ...
     * Sets campaignId
     *
     * @param string|null $campaignId Unique identifier for the campaign.
     *
     * @return self
     */
     ...
     * Sets impressions
     *
     * @param int|null $impressions The number of impressions for ads in the ad group.
     *
     * @return self
     */
     ...
     * Sets spent
     *
     * @param float|null $spent The amount spent on the ad group in EUR, with two decimals of precision.
     *
     * @return self
     */
     ...
     * Sets roas
     *
     * @param float|null $roas The Return on Advertising Spent for the ad group is a ratio of sales revenue versus ad spend, with four decimals of precision.
     *
     * @return self
     */
