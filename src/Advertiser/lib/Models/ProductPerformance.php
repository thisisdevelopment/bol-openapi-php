...
/**
 * ProductPerformance Class Doc Comment
 *
 * @category Class
 * @package  ThisIsDevelopment\OpenApi\Bol\Advertiser
 * @author   OpenAPI Generator team
 ...
 */
class ProductPerformance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductPerformance';
    ...
    */
     ...
     * Sets campaignId
     *
     * @param string $campaignId The identifier of the parent-campaign for the ad group.
     *
     * @return self
     */
     ...
     *
     * @param string|null $targetProductId The identifier of the target product.
     *
     * @return self
     */
     ...
     * Sets impressions
     *
     * @param int|null $impressions The number of impressions for the ads in the ad group.
     *
     * @return self
     */
     ...
     * Sets clicks
     *
     * @param int|null $clicks The number of clicks on ads in the ad group.
     *
     * @return self
     */
     ...
     * Sets conversions
     *
     * @param int|null $conversions The number of product sales that resulted from visitors viewing ads in this ad group, up to 14 days after they viewed the ad.
     *
     * @return self
     */
     ...
     *
     * @param float|null $conversionsOtherEan The number of conversions of similar products with a different EAN up to 14 days after a visitor viewed an ad.
     *
     * @return self
     */
     ...
     * Sets salesOtherEan
     *
     * @param float|null $salesOtherEan The value of sales in EUR of similar products with a different EAN up to 14 days after a visitor viewed an ad, with two decimals of precision.
     *
     * @return self
     */
     ...
     * Sets spent
     *
     * @param float|null $spent The amount spent on the product in the ad group in EUR, with two decimals of precision.
     *
     * @return self
     */
     ...
     * Sets acos
     *
     * @param float|null $acos The Advertising Cost Of Sale for the ad group is a ratio of the ad spend versus sales revenue, with four decimals of precision.
     *
     * @return self
     */
     ...
     * Sets roas
     *
     * @param float|null $roas The Return on Advertising Spent for the products in the ad group is a ratio of sales revenue versus ad spend, with four decimals of precision.
     *
     * @return self
     */
