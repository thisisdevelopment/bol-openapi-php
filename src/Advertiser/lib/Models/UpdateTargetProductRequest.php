...
/**
 * UpdateTargetProductRequest Class Doc Comment
 *
 * @category Class
 * @package  ThisIsDevelopment\OpenApi\Bol\Advertiser
 * @author   OpenAPI Generator team
 ...
 */
class UpdateTargetProductRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateTargetProductRequest';
    ...
    */
    ...
    public function setBid($bid)
    {
        ...
        if (($bid < 0)) {
            throw new \InvalidArgumentException('invalid value for $bid when calling UpdateTargetProductRequest., must be bigger than or equal to 0.');
        }
