...
/**
 * AdGroupsResponse Class Doc Comment
 *
 * @category Class
 * @description Container for multiple ad groups.
 * @package  ThisIsDevelopment\OpenApi\Bol\Advertiser
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AdGroupsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdGroupsResponse';
    ...
    protected static $openAPITypes = [
        'adGroups' => '\ThisIsDevelopment\OpenApi\Bol\Advertiser\Models\AdGroup[]'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['adGroups'] === null) {
            $invalidProperties[] = "'adGroups' can't be null";
        }
     ...
     * Gets adGroups
     *
     * @return \ThisIsDevelopment\OpenApi\Bol\Advertiser\Models\AdGroup[]
     */
     ...
     * Sets adGroups
     *
     * @param \ThisIsDevelopment\OpenApi\Bol\Advertiser\Models\AdGroup[] $adGroups adGroups
     *
     * @return self
     */
    ...
    {
        if (is_null($adGroups)) {
            throw new \InvalidArgumentException('non-nullable adGroups cannot be null');
        }
