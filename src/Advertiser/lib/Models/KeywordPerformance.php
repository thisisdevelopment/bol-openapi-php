...
/**
 * KeywordPerformance Class Doc Comment
 *
 * @category Class
 * @package  ThisIsDevelopment\OpenApi\Bol\Advertiser
 * @author   OpenAPI Generator team
 ...
 */
class KeywordPerformance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KeywordPerformance';
    ...
    */
     ...
     * Sets keywordId
     *
     * @param string|null $keywordId The identifier of the adgroup.
     *
     * @return self
     */
     ...
     * Sets impressions
     *
     * @param int|null $impressions The number of impressions from this keyword for ads in the ad group.
     *
     * @return self
     */
     ...
     * Sets clicks
     *
     * @param int|null $clicks The number of clicks from this keyword on ads in the ad group.
     *
     * @return self
     */
     ...
     * Sets ctr
     *
     * @param float|null $ctr The Click-Through Rate is a ratio of clicks versus impressions from this keyword, with four decimals of precision.
     *
     * @return self
     */
     ...
     * Sets conversionRate
     *
     * @param float|null $conversionRate The conversion rate is a ratio of the number of visitors who bought the product up to 14 days after viewing the ad with this keyword, versus those who only viewed the ad, with four decimals of precision.
     *
     * @return self
     */
     ...
     * Sets sales
     *
     * @param float|null $sales The value of sales in EUR that happened up to 14 days after the visitor viewed an ad with this keyword, with two decimals of precision.
     *
     * @return self
     */
     ...
     * Sets spent
     *
     * @param float|null $spent The amount spent on ads with this keyword in EUR, with two decimals of precision.
     *
     * @return self
     */
     ...
     * Sets cpc
     *
     * @param float|null $cpc The average Cost Per Click of ads with this keyword in EUR, with two decimals of precision.
     *
     * @return self
     */
     ...
     * Sets acos
     *
     * @param float|null $acos The Advertising Cost Of Sale for the ads with this keyword is a ratio of the ad spend versus sales revenue, with four decimals of precision.
     *
     * @return self
     */
     ...
     * Sets roas
     *
     * @param float|null $roas The Return on Advertising Spent for ads with this keyword is a ratio of sales revenue versus ad spend, with four decimals of precision.
     *
     * @return self
     */
     ...
     *
     * @param float|null $averageWinningBid The value of the average winning bid for ads that used this keyword in the ad group in EUR, with two decimals of precision.
     *
     * @return self
     */
