...
class CreateNegativeKeywordRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets keywordText
     *
     * @param string $keywordText The text or phrase used in the negative keyword that caused the ad not to be displayed to the user.
     *
     * @return self
     */
     ...
     * Sets matchType
     *
     * @param string $matchType The match type that relates the negative keyword and the search term.
     *
     * @return self
     */
